...
void Player_::Move() {
	...
	if (State() == LIZAMONG || State() == LARGETINO) {
		if (Images.NowStage() == STAGE1 || Images.NowStage() == STAGE3) defaultGroundY_ = 433;
		else if (Images.NowStage() == HIDDEN) defaultGroundY_ = 421;
		else if (Images.NowStage() == STAGE2) defaultGroundY_ = 451;
	}
	else {
		if (Images.NowStage() == STAGE1 || Images.NowStage() == STAGE3) defaultGroundY_ = 447;
		else if (Images.NowStage() == HIDDEN) defaultGroundY_ = 435;
		else if (Images.NowStage() == STAGE2) defaultGroundY_ = 465;
	}
